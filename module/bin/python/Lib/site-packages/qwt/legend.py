...
try:
    from qtpy.QtWidgets import qDrawWinButton
    HAS_QDRAWWINBUTTON = True
except BaseException:
    HAS_QDRAWWINBUTTON = False
...
class QwtLegendLabel(QwtTextLabel):
    ...
    def setText(self, text):
        ...
        flags |= Qt.TextExpandTabs | Qt.TextWordWrap
        txt = text  # TODO: WTF?
    ...
    def paintEvent(self, e):
        ...
        if self.__data.isDown and HAS_QDRAWWINBUTTON:
...
class QwtLegend(QwtAbstractLegend):
    ...
    clicked = Signal(ObjectStr, int)
    checked = Signal(ObjectStr, bool, int)
