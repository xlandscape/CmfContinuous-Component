# -*- coding: utf-8 -*-
"""
Created on Fri Jul 19 09:10:43 2013
...
class PET(object): 
    ...
    def calc_Rs_Hargreaves(self,Tmin,Tmax,Ra,kRs=.16):
        """
        ...
        large land mass and where air masses are influenced by a nearby water body, kRs @ 0.19.
            """
        Rs = kRs * (Tmin - Tmax)**(1/2) * Ra
        return Rs
    
    def calc_Rs_Supit(self,Ra,Tmax,Tmin,CC,A_s,B_s,C_s):
        """
    ...
    def calc_Rs_Angstrom(self,actual_sunshine_hours,daylight_hours,Ra,a_s=.25,b_s=.5):
        """
